...
/**
 * Title: Header Media No Image
 * Slug: bizboost/header-media-no-image
 * Categories: bizboost, page
 */
?>

<!-- wp:cover {"dimRatio":0,"overlayColor":"background","align":"wide","className":"wp-block-section wp-block-header-media-no-image"} -->
<div class="wp-block-cover alignwide wp-block-section wp-block-header-media-no-image"><span aria-hidden="true" class="wp-block-cover__background has-background-background-color has-background-dim-0 has-background-dim"></span>
    <div class="wp-block-cover__inner-container"><!-- wp:group {"layout":{"type":"constrained"}} -->
        <div class="wp-block-group"><!-- wp:group {"className":"header-title-wrapper","layout":{"type":"constrained","justifyContent":"center"}} -->
            ...
            <!-- /wp:group -->
            <!-- wp:paragraph {"align":"center","textColor":"body-text","fontSize":"content-heading"} -->
            <p class="has-text-align-center has-body-text-color has-text-color has-content-heading-font-size"><?php esc_html_e('We collaborate with smart and creative people to build awesome WordPress Full Site Editing Themes.', 'bizboost'); ?></p>
            <!-- /wp:paragraph -->
            ...
            <div class="wp-block-buttons" style="margin-top:14px"><!-- wp:button -->
                <div class="wp-block-button"><a class="wp-block-button__link wp-element-button"><?php esc_html_e('Get Started', 'bizboost'); ?></a></div>
                <!-- /wp:button -->
            </div>
            <!-- /wp:buttons -->
        </div>
