...
<div class="wp-block-group alignfull">
    <!-- wp:group {"className":"wp-block-main-header","align":"wide","layout":{"inherit":true}} -->
    <div class="wp-block-group alignwide wp-block-main-header">
        ...
        <div class="wp-block-group alignwide" style="padding-top: var(--wp--custom--spacing--tiny); padding-bottom: var(--wp--custom--spacing--tiny);">
            ...
            <div class="wp-block-group">
                ...
                <!-- wp:group -->
                <div class="wp-block-group"><!-- wp:site-title /--><!-- wp:site-tagline {"style":{"spacing":{"margin":{"top":"0"}}}} /--></div>
                <!-- /wp:group -->
            </div>
            <!-- /wp:group -->
